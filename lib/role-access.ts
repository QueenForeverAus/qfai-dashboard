...
export const ROLE_ACCESS: Record<string, { pages: string[]; tabs: string[] }> = {
  admin:      { pages: ['/', '/runs', '/advancing', '/emails', '/settlement', '/settlements', '/feedback', '/admin', '/admin-settings', '/factors', '/ticket-sales', '/settings', '/profile'], tabs: ['costs', 'outlook', 'audit', 'run_advancing', 'advancement', 'show_pack'] },
  owner:      { pages: ['/', '/runs', '/advancing', '/emails', '/settlement', '/settlements', '/feedback', '/factors', '/admin-settings', '/ticket-sales', '/settings', '/profile'],           tabs: ['costs', 'outlook', 'audit', 'run_advancing', 'advancement', 'show_pack'] },
