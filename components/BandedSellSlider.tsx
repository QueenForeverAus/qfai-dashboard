...
type Props = {
  ...
  className?: string
  /** Locked until cost lines leave FIGURES NEEDED. */
  disabled?: boolean
}
 ...
 */
export default function BandedSellSlider({ value, onChange, capacity, capacityBands, className, disabled = false }: Props) {
